...
mod blame_cache_to_hunks {
    ...
    fn no_changes() {
        ...
        let (updated_blame_entries, new_unblamed_hunks) = process_changes_forward(&cached_blames, changes, one_sha());
    ...
    fn add_or_replace_full_blame_delete() {
        ...
        let (updated_blame_entries, new_unblamed_hunks) = process_changes_forward(&cached_blames, changes, two_sha());
        assert_eq!(updated_blame_entries, expected_blame);
